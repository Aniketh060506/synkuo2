...
console.log('[Content] SynkUp content script loaded');
...
function captureSelection() {
    if (!isConnected) {
        showToast('⚠️ Please open SynkUp desktop app', 'warning');
        return;
    }
    ...
    chrome.runtime.sendMessage({
        ...
        if (response && !response.success) {
            ...
            showToast('📤 Sending to SynkUp...', 'info');
        }
    });
}
...
console.log('[Content] SynkUp content script ready');
